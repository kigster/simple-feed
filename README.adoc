...
image:https://github.com/kigster/simple-feed/workflows/RSpec/badge.svg?branch=main[RSpec,link=https://github.com/kigster/simple-feed/actions?query=workflow%3ARSpec]
image:https://github.com/kigster/simple-feed/workflows/Rubocop/badge.svg?branch=main[Rubocop,link=https://github.com/kigster/simple-feed/actions?query=workflow%3ARubocop]
...
image:https://codecov.io/gh/kigster/simple-feed/branch/main/graphs/sunburst.svg[Coverage Map,link=https://codecov.io/gh/kigster/simple-feed/branch/main]

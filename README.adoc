...
image:https://github.com/kigster/simple-feed/workflows/RSpec/badge.svg[RSpec,link=https://github.com/kigster/simple-feed/actions?query=workflow%3ARSpec]
image:https://github.com/kigster/simple-feed/workflows/Rubocop/badge.svg?branch=master%5BRuby,link=https://github.com/kigster/simple-feed/actions?query=workflow%3ARubocop%5D
